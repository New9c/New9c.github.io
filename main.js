function start_everything(){
    ...
    document.getElementById("starting_questions").innerHTML += "<label for='starting question 1'>What do you wanna do?</label><br><br>"
    document.getElementById("starting_questions").innerHTML += `<input class='brawler button' type='button' value="Tell me when I'll get my new brawler" id='brawler button' onclick='make_question(1)'><br><br>`
    document.getElementById("starting_questions").innerHTML += `<input class='future_days button' type='button' value="Tell me the rewards I'll get in ? days" id='future_days button' onclick='make_question(2)'>`
}
...
function make_question(type) {
    ...
    document.getElementById(`${things[1]} question`).innerHTML += `<input class="standard button" type="button" value="Standard Calculation" id="standard" onclick="make_${things[1]}_question(1)"><br><br>`
    document.getElementById(`${things[1]} question`).innerHTML += `<input class="fast button" type="button" value="Fast Calculation" id="fast" onclick="make_${things[1]}_question(2)"><br><br>`
...
function make_brawler_standard_questions(credits_needed) {
    ...
    document.getElementById("brawler standard questions").innerHTML += "<input type='text' id='credit amount' oninput='restart_ready()'><br>"
    ...
    document.getElementById("brawler standard questions").innerHTML += "<input type='text' id='current token amount' oninput='restart_ready()'><br>"
...
function make_brawler_fast_questions(credits_needed) {
    ...
    document.getElementById("brawler fast questions").innerHTML += "<input type='text' id='credit amount' oninput='restart_ready()'><br>"
    needed_credit_amount = credits_needed;
...
function make_future_days_question(type_sf) {
    ...
    document.getElementById(`future_days ${things[1]} question`).innerHTML += "<input type='text' id='days asked'><br>"
